page 50854 "PF_CustSer&Sales Role Center"
{
    PageType = RoleCenter;
    // SourceTable = "Customer Service and Sales Setup";
    ApplicationArea = All;
    UsageCategory = Administration;
    Caption = 'Customer Service and Sales';
    //ProfileId = 'PF_CustomerServiceAndSales';
    ...
    layout
    {
        area(rolecenter)
        {
            ...
            part(Control16; "PF_CustService&SalesActivities")
            {
...
#pragma warning restore AS0072
        ...
        area(embedding)
        {
            ...
            action(PostedInvoicesLines)
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Posted Sales Lines';
                // RunObject = Page "Posted Sales Order";
            ...
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Sales Uploads';
                Image = BankAccount;
                RunObject = Page "PF_Import Sales Data";
                ToolTip = 'View or set up detailed information about your bank account, such as which currency to use, the format of bank files that you import and export as electronic payments, and the numbering of checks.';
            }
            action("BulkUploads")
            {
                ApplicationArea = Basic, Suite;
                Caption = 'Bulk Upload tool';
                RunObject = Page "PF_Import Sales Data";
