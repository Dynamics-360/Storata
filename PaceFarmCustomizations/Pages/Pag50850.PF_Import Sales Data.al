page 50850 "PF_Import Sales Data"
{
    ApplicationArea = All;
    Caption = 'Import Sales Data';
    PageType = Worksheet;
    MultipleNewLines = true;
    SourceTable = "PF_ImportSalesHeader";
    UsageCategory = Lists;
    AutoSplitKey = false;
    SaveValues = true;
    DeleteAllowed = true;
    ...
    layout
    {
        area(Content)
        {
            ...
            part(StorataalesLines; "PF_Import Sales Lines")
            {
                ApplicationArea = All;
            }
        }
    ...
    var
        ImportSalesHead: Record "PF_ImportSalesHeader";
    begin
